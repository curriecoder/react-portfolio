  ...
  return (
    <div className="container">
      ...
      <p className="mx-auto my-5">
        ...
        school was working with HTML 3.2, doing pretty much everything in-line. I continued
        playing around with HTML and CSS for many years and now I'm back with renewed vigor! I served in the U.S. Army for five
        years straight out of high school, learning much about the world during
        that time. After that chapter had closed, I began searching for my next
